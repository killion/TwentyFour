  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trip as @trip" do
        ...
        post :create, {:trip => { "latitude" => "invalid value" }}, valid_session
        assigns(:trip).should be_a_new(Trip)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trip" do
        ...
        Trip.any_instance.should_receive(:update_attributes).with({ "latitude" => "1.5" })
        put :update, {:id => trip.to_param, :trip => { "latitude" => "1.5" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trip as @trip" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trip.any_instance.stub(:save).and_return(false)
        put :update, {:id => trip.to_param, :trip => { "latitude" => "invalid value" }}, valid_session
        assigns(:trip).should eq(trip)
      end
